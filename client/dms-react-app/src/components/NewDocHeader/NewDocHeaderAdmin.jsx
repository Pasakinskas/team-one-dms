      ...
      const {text} = this.state;
        return (
          <div className="newDocHead">
            <FontAwesomeIcon className="one" icon="address-card" onClick={() =>this.nextPath(`/adminboarddocs`)} data-toggle="tooltip" title="Tooltip on right"  onMouseOver = {this.onMouseover} onMouseOut = {this.onMouseout}/>
